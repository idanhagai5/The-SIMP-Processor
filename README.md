...
The input file `program.asm` stores the assembly program, while the output file `memin.txt` save the resulting memory image. The output file generated by the assembler serves as the input file for the simulator.
